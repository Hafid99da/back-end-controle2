...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ route('paiements.update', $paiement) }}" method="post">
        ...
        <input type="text" name="date_paiement" id="date_paiement" value="{{$paiement->date_paiement}}" class="form-control">
        @error('date_paiement')
          <div class="text-danger">{{$message}}</div>
        @enderror</br>
        <label>Montant</label></br>
        <input type="text" name="montant" id="montant" value="{{$paiement->montant}}" class="form-control">
        @error('montant')
          <div class="text-danger">{{$message}}</div>
        @enderror</br>
