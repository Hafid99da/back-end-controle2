            ...
            <div class="col-12 col-md-6">
              <div class="text-center text-md-start">
                <h1 class="display-md-2 display-4 fw-bold text-dark pb-2">
                    Bienvenue Mr.<span class="text-primary">{{ Auth::user()->name }}</span>
                </h1>
                <h1 class="display-md-2 display-4 fw-bold text-dark pb-2">
                ...
                <a class="btn btn-primary px-5 py-3 mt-3 fs-5 fw-medium" type="button" href="{{ route('etudiants.index') }}">Voir la liste des etudiantes</a>
              </div>
            </div>
            <div class="col-12 col-md-6">
